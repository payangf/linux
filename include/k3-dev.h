...
#define PSC(_id, _base)
{ .id = _id, .base = (void *)_base, }
#define PSC_PD(_id, _psc, _depend)
{ .id = _id, .psc = _psc, .depend = _depend }
#define PSC_LPSC(_id, _psc, _pd, _depend)
{ .id = _id, .psc = _psc, .pd = _pd, .depend = _depend }
#define PSC_DEV(_id, _lpsc)
{ .id = _id, .lpsc = _lpsc }
